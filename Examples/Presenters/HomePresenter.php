...
class HomepagePresenter extends Presenter
{
	...
	protected function createComponentTestForm()
	{
		...
		$form->addCheckbox('function', 'form.nastaveni_cookies.function.title')->setText('form.nastaveni_cookies.function.text');
                $ritems = [];
                $ritems[] = (new Radio('country','form.country1.title'))->setText('form.country1.text');
		$ritems[] = (new Radio('country','form.country2.title'))->setText('form.country2.text');
                $form->addRadios( 'form.country.label', $ritems)->setRequired('form.defaults.messages.required');
//                $form->addRadios( 'form.country.label', $ritems);
